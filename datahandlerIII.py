...
class IIIRNNDataHandler:
    ...
    def get_gap_range(self):
        return self.smallest_gap, self.greatest_gap
    ...
    def get_next_batch(self, dataset, dataset_session_lengths, time_set):
        ...
        user_list = IIIRNNDataHandler.get_N_highest_indexes(remaining_sessions, self.batch_size)
        if(len(user_list) == 0):
            return [],[],[],[],[],[],[],[]
